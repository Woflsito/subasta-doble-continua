    ...
    function sendAcc(is_bid) {
        ...
        if (elAssetsHolding.length > 0) {
            elAssetsHolding.html(assetsHolding);
            console.log("[DEBUG] UI después de actualizar: ", elAssetsHolding.html());
        } else {
            console.log("[ERROR] No se encontró el elemento donde actualizar assetsHolding");
        }
